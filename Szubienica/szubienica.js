...
String.prototype.ustawZnak = function(miejsce,znak)
{
	...
	else return this.substr(0,miejsce)+
				znak+
				this.substr(miejsce+1);
}
function sprawdz(nr)
{
	var trafiona = false;
	...
	if(ileskuch>=9)
	{	
		document.getElementById("alfabet").innerHTML="Niestety! Podano  nie prawidlowe haslo" +haslo+'<br/><br/><span class="reset2" onclick="location.reload()">JESZCZE RAZ ?</span>';
	}
}